  ...
  useEffect(() => {
    ...
    > = {
      ...
      portfolio: {
        ...
        description: isRo
          ? 'Explorați cele 13 divizii active ale Ragnar Elite Holding, incluzând imobiliare de lux, tehnologii disruptive, gestionare active și servicii partajate.'
          : 'Explore the 13 active divisions of Ragnar Elite Holding, covering luxury real estate, disruptive technologies, asset management, and shared corporate services.',
        keywords: isRo
