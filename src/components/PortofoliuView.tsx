...
export default function PortofoliuView({ currentLang }: PortofoliuViewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] bg-grid-pattern text-[#2F4156] selection:bg-[#2F4156] selection:text-white relative overflow-hidden">
            ...
            <div key={idx} className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-[#2F4156]/10 pt-16">
              <div className="lg:col-span-4">
                <div className="sticky top-32 space-y-4">
                  ...
                  <div className="w-14 h-14 bg-[#2F4156] flex items-center justify-center rounded-lg border border-white/5 shadow-inner">
                    <div.icon className="w-7 h-7 text-[#C8D9E6]" />
                  </div>
